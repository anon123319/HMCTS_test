...
describe("createTask Validation Tests", () => {
  ...
  it("should validate title length (too short)", async () => {
    ...
    expect(errors.array()[0].msg).toBe("Title must be between 3 and 100 characters long.");
  });
  ...
  it("should validate description length", async () => {
    ...
    const errors = validationResult(req);
    expect(errors.isEmpty()).toBe(false);
    expect(errors.array()[0].msg).toBe("Description must be less than 501 characters.");
  });
  ...
  it("should validate status value", async () => {
    ...
    const errors = validationResult(req);
    expect(errors.isEmpty()).toBe(false);
    expect(errors.array()[0].msg).toBe("Status must be one of TODO, IN_PROGRESS, DONE.");
  });
  ...
  it("should validate due-day", async () => {
    ...
    const errors = validationResult(req);
    expect(errors.isEmpty()).toBe(false);
    expect(errors.array()[0].msg).toBe("Due day must be a number between 1 and 31.");
  });
  ...
  it("should validate due-month", async () => {
    ...
    const errors = validationResult(req);
    expect(errors.isEmpty()).toBe(false);
    expect(errors.array()[0].msg).toBe("Due month must be a number between 1 and 12.");
  });
  ...
  it("should validate due-year", async () => {
    ...
    const errors = validationResult(req);
    expect(errors.isEmpty()).toBe(false);
    expect(errors.array()[0].msg).toBe("Due year must be a number between 2000 and 2100.");
  });
